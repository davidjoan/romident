...
class Deb
{
  ...
  public static function printToArray($object, $deep = true)
  {
    self::print_r($object->toArray($deep));
  }
  public static function printToArray_pre($object, $deep = true)
  {
    self::print_r_pre($object->toArray($deep));
  }
  
  public static function log_print_r($var)
  {
