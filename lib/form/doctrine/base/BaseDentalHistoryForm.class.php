...
/**
 * DentalHistory form base class.
 *
 * @method DentalHistory getObject() Returns the current form's model object
 *
 * @package    romident
 * @subpackage form
 ...
 */
abstract class BaseDentalHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'DentalHistory', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('dental_history[%s]');
