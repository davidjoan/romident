...
function PDF($orientation='P', $unit='mm', $size='A4')
{
  ...
  function HistoriaClinicaPDF($orientation='P', $unit='mm', $size='A4', $codigo)
  {
  	$this->codigo = $codigo;  	
  ...
  function Header()
  {
    $this->Image(sfConfig::get('sf_web_dir') .'/images/general/logo.png',10,8,33);
    $this->SetFont('Arial','B',15);
    $this->Cell(45);
    $titulo = 'Historia Clinica Odontológica';
